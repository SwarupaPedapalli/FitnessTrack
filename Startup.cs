...
namespace FitnessTracker
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            */
            services.AddDbContext<ApplicationDbContext>(x => x.UseSqlServer("Server=NW48789;Database=aspnet-FitnessTracker;Trusted_Connection=True;MultipleActiveResultSets=true"));
            //services.AddDbContext<ApplicationDbContext>(x=>x.mysql)
